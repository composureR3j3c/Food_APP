...
import { DeliveryUserLogin, DeliveryUserSignup, DeliveryUserStatus, EditDeliveryUserProfile, GetDeliveryUserProfile } from '../controllers';
...
router.post('/change-status',DeliveryUserStatus);
